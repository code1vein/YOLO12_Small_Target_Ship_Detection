...
# 数据集规模与抽样控制
BASELINE_TARGET_TOTAL_IMAGES = 6200
BASELINE_TARGET_SMALL_IMAGE_RATIO = 0.62
BASELINE_NOISE_AUG_RATIO = 0.1
BASELINE_NOISE_MAX_IMAGES = 450

AUGMENTATION_TARGET_TOTAL_IMAGES = 10000
AUGMENTATION_WEATHER_BUDGET_RATIO = 0.95
AUGMENTATION_COPYPASTE_BUDGET_RATIO = 0.02
