...
from config import COPYPASTE_TARGET_SMALL_RATIO, DATA_AUGMENTATION_DIR, DATA_BASELINE_DIR
...
def build_augmentation_dataset(
    ...
    print("\n[1/3] 构建天气增强样本")
    create_weather_augmented_dataset(enhancement_ratio=weather_ratio)
